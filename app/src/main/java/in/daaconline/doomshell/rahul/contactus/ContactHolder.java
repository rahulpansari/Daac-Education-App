...
Context c;
    ...
    public void onClick(View v) {
        ...
        {
            Uri uri=Uri.parse("google.navigation:q="+ ContactRecycler.contact.get(getAdapterPosition()).getLat()+","+ ContactRecycler.contact.get(getAdapterPosition()).getLong());
        ...
        {String phone[]= ContactRecycler.contact.get(getAdapterPosition()).getPhone().split(",");
            Uri uri;
